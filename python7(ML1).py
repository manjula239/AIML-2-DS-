...
titanic_train = pd.read_csv(r"C:\Users\user\Downloads\train.csv")
os.chdir(r"C:\Users\user\Downloads\kaggle-survey-2020.zip")
...
#Read the Test Data
titanic_test = pd.read_csv(r"C:\Users\user\Downloads:\\kaggle-survey-2020.zip\\Data\\titanin.csv")
