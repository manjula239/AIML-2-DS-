...
os.chdir("C:/Users/user/Desktop/Manju Files")

titanic_train = pd.read_csv("C:\\Users\\user\\Downloads\\Train1.csv")
titanic_train.shape
titanic_train.info()

titanic_test = pd.read_csv("C:\\Users\\user\\Downloads\\Test1.csv")
titanic_test.shape
titanic_test.info()
