...
titanic_train = pd.read_csv("C:\\Users\\user\\Downloads\\train.csv")
...
#Read the Test Data
titanic_test = pd.read_csv("C:\\Users\\user\\Downloads\\test.csv")
...
titanic_test.to_csv("submission_Titanic3.csv", columns=['PassengerId','Survived'], index=False)